...
export const SETTINGS_DEFINITIONS: SettingDefinition[] = [
	...
	{
		isSection: true,
		key: '_sec_visuals_onroad',
		label: 'Onroad Visuals',
		description: '',
		category: 'visuals'
	},
	{
