...
export const SETTINGS_DEFINITIONS: SettingDefinition[] = [
    ...
    { key: 'DeviceBootMode', label: 'Boot Mode', description: 'Boot/Wake-Up in Offroad or Normal mode', category: 'device'},
    ...
    { key: 'OnroadUploads', label: 'Onroad Uploads', description: 'Enable Onroad Uploads', category: 'device'},
    ...
    // Toggles
    { key: 'OpenpilotEnabledToggle', label: 'sunnypilot Enabled', description: 'Master sunnypilot toggle', category: 'toggles' },
    { key: 'LongitudinalPersonality', label: 'Personality', description: 'Driving style preference', category: 'toggles' },
    { key: 'IsLdwEnabled', label: 'LDW Enabled', description: 'Lane departure warnings', category: 'toggles' },
    ...
    { key: 'LagdToggle', label: 'LAGD Toggle', description: 'Live Learning Steer Delay', category: 'toggles', advanced: true },
    { key: 'LagdToggleDelay', label: 'LAGD Toggle Delay', description: 'Adjust the software delay when Live Learning Steer Delay is toggled off', category: 'toggles', advanced: true },
    { key: 'LaneTurnDesire', label: 'Lane Turn Desire', description: 'Use Lane Turn Desires', category: 'toggles'},
    { key: 'LaneTurnValue', label: 'Adjust Lane Turn Speed', description: 'Adjust Lane Turn Desire Activation Speed', category: 'toggles'},
    ...
    { key: 'LiveTorqueParamsToggle', label: 'Live Torque Params', description: 'Self-tune torque parameters', category: 'steering', advanced: true },
    { key: 'LiveTorqueParamsRelaxedToggle', label: 'Relaxed Torque Params', description: 'Less restrictive settings for self-tune', category: 'steering', advanced: true },
    { key: 'CustomTorqueParams', label: 'Custom Torque Params', description: 'Use manual torque values', category: 'steering', advanced: true },
    { key: 'TorqueParamsOverrideEnabled', label: 'Override Torque Params', description: 'Enable manual real-time tuning override', category: 'steering', advanced: true },
    { key: 'TorqueParamsOverrideLatAccelFactor', label: 'Override Lat Accel', description: 'Manual lateral accel factor', category: 'steering', advanced: true},
    ...
    { key: 'AutoLaneChangeTimer', label: 'Auto Lane Change Delay', description: 'Wait time before auto change', category: 'steering', advanced: true},
    { key: 'AutoLaneChangeBsmDelay', label: 'BSM Safety Delay', description: 'Blind spot monitoring delay', category: 'steering', advanced: true },
    ...
    { key: 'DynamicExperimentalControl', label: 'Dynamic Experimental', description: 'Auto-toggle experimental mode', category: 'cruise', advanced: true },

		{ isSection: true, key: '_sec', label: 'Speed Limit Assist', description: '', category: 'cruise' },
    ...
    { key: 'SpeedLimitValueOffset', label: 'Speed Limit Offset Value', description: 'Value for speed offset', category: 'cruise' },

		{ isSection: true, key: '_sec', label: 'Smart Cruise Control', description: '', category: 'cruise' },
    ...
    { key: 'HyundaiLongitudinalTuning', label: 'Hyundai Long. Tuning', description: 'Longitudinal tuning for Hyundai', category: 'cruise', advanced: true },
    ...
    { key: 'Brightness', label: 'Global Brightness', description: 'Screen brightness level', category: 'visuals' },
    { key: 'OnroadScreenOffControl', label: 'Onroad Brightness Control', description: 'Onroad brightness control', category: 'visuals' },
    { key: 'OnroadScreenOffBrightness', label: 'Onroad Brightness', description: 'Onroad Brightness', category: 'visuals' },
    { key: 'OnroadScreenOffTimer', label: 'Onroad Brightness Timer', description: 'Time before onroad brightness is lowered', category: 'visuals' },
    ...
    { key: 'DevUIInfo', label: 'Dev UI Info', description: 'Developer UI overlay data', category: 'visuals'},
    { key: 'ChevronInfo', label: 'Lead Car Chevron Info', description: 'Lead vehicle info', category: 'visuals'},
    { key: 'BlindSpot', label: 'Blind Spot', description: 'Blind spot detection enabled', category: 'visuals'},
    ...
    { key: 'ShowAdvancedControls', label: 'Show Advanced Controls', description: 'Show advanced controls on device', category: 'developer', advanced: true },
    { key: 'QuickBootToggle', label: 'Quick Boot', description: 'Enable quick boot', category: 'developer', advanced: true },
    { key: 'EnableCopyparty', label: 'Enable File Server', description: 'Enable Copyparty file server', category: 'developer', advanced: true },
    { key: 'JoystickDebugMode', label: 'Joystick Debug', description: 'Enable joystick debugging', category: 'developer', advanced: true },
    { key: 'LongitudinalManeuverMode', label: 'Maneuver Mode', description: 'Specialized maneuver handling', category: 'developer', advanced: true },

		{ isSection: true, key: '_sec', label: 'sunnypilot CI Settings', description: '', category: 'developer' },
    ...
    { key: 'SunnylinkDongleId', label: 'sunnylink ID', description: 'sunnylink device identifier', category: 'developer', readonly: true },

    // Hidden Settings
    { key: 'ObdMultiplexingEnabled', label: 'OBD Multiplexing', description: 'Enable OBD multiplexing', category: 'developer', advanced: true, hidden: true },
    { key: 'IsDriverViewEnabled', label: 'Driver View', description: 'Show driver monitoring camera', category: 'visuals', hidden: true },
    { key: 'MapAdvisorySpeedLimit', label: 'Map Advisory Speed', description: 'Respect map advisory limits', category: 'cruise', hidden: true },
    { key: 'RecordFrontLock', label: 'Lock Front Recording', description: 'Prevent deleting front recordings', category: 'device', advanced: true, hidden: true },
    ...
    { key: 'ModelManager_ActiveBundle', label: 'Active Model Bundle', description: 'Currently active model', category: 'developer', advanced: true, readonly: true, hidden: true },
