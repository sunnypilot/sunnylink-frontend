...
{#if changeCount > 0}
	<div
		...
		class="fixed bottom-6 left-1/2 z-40 flex -translate-x-1/2 items-center gap-4 rounded-full border border-[#334155] bg-[#1e293b]/90 px-6 py-3 shadow-2xl backdrop-blur-md"
	>
