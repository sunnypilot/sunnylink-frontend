		...
		>
				<div class="border-b border-[var(--sl-border)] bg-[var(--sl-bg-input)] p-4 sm:p-6">
					<div class="flex items-center gap-3">
						...
						<h3 class="text-lg font-bold text-[var(--sl-text-1)] sm:text-xl">Device Connection Required</h3>
					</div>
				</div>

				<div class="space-y-3 p-4 sm:space-y-4 sm:p-6">
					<p class="text-sm text-[var(--sl-text-2)] sm:text-base">To configure settings, your device must be online. Here's why:</p>
